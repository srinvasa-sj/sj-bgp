...
//           const sortedImages = [...imageData].sort((a, b) => b.timestamp - a.timestamp);
...
//     <div className="container mx-auto px-4">
//       <h1 className="text-4xl font-bold mb-8">Gallery</h1>
//       <div id="image-gallery" className="relative w-full h-[500px] overflow-hidden rounded-lg">
//         <img
...
//       <div className="container mx-auto px-4">
//         <h1 className="text-4xl font-bold mb-8 text-center">Gallery</h1>
//         <p className="text-gray-500 text-center">No images available in the gallery.</p>
//       </div>
//     );
//   }
...
//               index === currentImageIndex ? "border-4 border-primary scale-110" : "border border-gray-300"
//             }`}
